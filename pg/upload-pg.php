...
if (isset($_FILES['excelFile']) && $_FILES['excelFile']['error'] == UPLOAD_ERR_OK) {
    ...
    try {
        ...
        $createTableQuery = "CREATE TABLE IF NOT EXISTS pg (id INT AUTO_INCREMENT PRIMARY KEY, ";
    ...
    // Redirect ke halaman display-pg.php dengan status sebagai query parameter
    header("Location: display-pg.php?status=$status");
    exit();
} else {
    // Redirect ke halaman display-pg.php dengan status gagal jika tidak ada file yang diunggah
    header("Location: display-pg.php?status=gagal");
    exit();
}
